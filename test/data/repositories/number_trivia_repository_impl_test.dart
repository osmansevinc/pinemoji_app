...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline( () {
      ...
      test(
        'should return remote data when the call to remot data source is successful',
        () async {
          // arrange
    ...
    runTestsOffline( () {
      ...
      test(
        'should return Cache Failure last locally cached data when the cached data present',
            () async {
          // arrange
          when(mockLocalDataSource.getLastNumberTrivia())
